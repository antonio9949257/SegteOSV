-- Insertar usuarios (técnicos, clientes y admin)
...
-- Insertar ubicaciones de usuarios
...
-- Insertar solicitudes de soporte
...
('Concluido'),
('Cancelado');
-- Insertar registros de estados de instalaciones
INSERT INTO estados_instalaciones (instalacion_id, estado_id, usuario_id, precio) VALUES
(1, 1, 1, 50.00), -- Pendiente, asignado al técnico admin
(2, 1, 2, 150.00), -- Pendiente, asignado al técnico user
(3, 2, 3, 75.00), -- Concluido, asignado al técnico técnico
(4, 2, 4, 100.00); -- Concluido, asignado al técnico técnico
-- Insertar comentarios sobre solicitudes de soporte
